...
//Criar insere uma publicao no banco de dados
...
//BuscarPorID traz uma unica publicacao do BD
...
// Buscar traz as publicações do proprio usuário e de quem segue
...
// Deletar apaga uma publicacao no banco de dados
